...
var marshMallow =
    'https://w0.pngwave.com/png/442/377/alone-electric-daisy-carnival-disc-jockey-song-drawing-others-png-clip-art-thumbnail.png';
var rosieLove =
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ItemCard('lib/assets/blue.jpg', 'Bass-Full'),
                SizedBox(
                  width: 16.0,
                ),
                ItemCard('lib/assets/pink.jpg', 'Calm & Relaxing'),
              ],
            ),
            SizedBox(
              height: 16.0,
            ...
            Row(
              children: <Widget>[
                ItemCard('lib/assets/orange.jpg', 'Bollywood'),
                SizedBox(
                  width: 16.0,
                ),
                ItemCard('lib/assets/yellow.jpg', 'Trending Albums'),
              ],
            ),
            SizedBox(
              width: 32.0,
            ...
            SongItem('Friends', 'Marshmello', marshMallow),
            SongItem('Worry Bout Us', 'Rosie Lowe', rosieLove),
          ],
        ),
      ),
    );
